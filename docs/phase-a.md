...
A bank with its own datacenter should use a Hybrid Cloud model.•This hybrid approach gives the best of both worlds: control over critical data + cloud agility for everything else.
